...
import { idlFactory } from './lectures_backend.did.js';
export { idlFactory } from './lectures_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LECTURES_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./lectures_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the lectures_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./lectures_backend.did.js")._SERVICE>}
 */
export const lectures_backend = createActor(canisterId);
