...
import { idlFactory } from './lectures_frontend.did.js';
export { idlFactory } from './lectures_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LECTURES_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./lectures_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the lectures_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./lectures_frontend.did.js")._SERVICE>}
 */
export const lectures_frontend = createActor(canisterId);
